...
Numbering: TC-001-099 Happy Path, TC-100-199 Business Rules, TC-200-299 Security,
TC-300-399 Negative, TC-400-499 Edge Cases, TC-500-599 UI State.

## Rules
- Be exhaustive — cover every flow in the domain skill
- Every scenario must trace back to a documented rule or discovered behavior
- Don't just test happy paths — edge cases and negative paths find the most bugs
- Reference test data from `playwright/testdata/users.json` where applicable
