---
mode: agent
description: Run the suite, classify what went red, fix what is safely fixable, re-run to prove it, and report — the closed maintenance loop (mirrors the autopilot Claude Code skill).
---
...
- Copilot has no subagent equivalent of the Claude Code delegation steps — run
  ...
  `.github/prompts/heal-test.prompt.md` and
  `.github/prompts/generate-tests.prompt.md` in that order, on the failures
